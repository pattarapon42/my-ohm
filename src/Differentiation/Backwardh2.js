    ...
    backwardh2(x, h, degree) {
        switch (degree) {
            case 1:
                ...
                break;
            case 2:
                y = (2*this.func(x) - 5*this.func(x-(1*h)) + 4*this.func(x-(2*h)) - this.func(x-(3*h))) / pow(h, 2)
                break;
            case 3:
                y = (5*this.func(x) - 18*this.func(x-(1*h)) + 24*this.func(x-(2*h)) - 14*this.func(x-(3*h)) + 3*this.func(x-(3*h))) / (2*pow(h, 3))
                break;
            default:
                y = (3*this.func(x) - 14*this.func(x-(1*h)) + 26*this.func(x-(2*h)) - 24*this.func(x-(3*h)) + 11*this.func(x-(4*h)) - 2*this.func(x-(5*h))) / pow(h, 4) 
        } 
    ...
    render() {
        return(
            <div style={{padding: "30px" }}>
                <h2 style={{color: "#ffffff", fontWeight: "bold"}}>Backward Divided-Differences O(h<sup>2</sup>)</h2>
